          ...
          <div className="p-5 space-y-4">
            ...
            <div className="bg-gradient-to-br from-primary to-indigo-600 rounded-xl p-5 text-white shadow-md">
              ...
              <div className="flex flex-col sm:flex-row gap-2">
                <Link href="/sign-up" className="flex-1 text-center px-5 py-2.5 bg-white text-primary rounded-xl font-semibold text-sm hover:bg-slate-50 transition-all flex items-center justify-center gap-2" data-testid="button-yukti-demo-signup">
